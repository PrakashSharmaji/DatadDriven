...
public class FixedDepositCalculator {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		String file=System.getProperty("user.dir")+"\\testdata\\caldata.xlsx";//Excel file path or location
		...
		for(int i=1;i<=rows;i++)
		{
			...
			String per2=ExcelUtils.getCellData(file,"Sheet1",i,3);//years
			String fre=ExcelUtils.getCellData(file,"Sheet1",i,4);//Simple Interest
